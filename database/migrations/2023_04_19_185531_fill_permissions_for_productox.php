...
class FillPermissionsForProductox extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProductox constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.productox',
            'admin.productox.index',
            'admin.productox.create',
            'admin.productox.show',
            'admin.productox.edit',
            'admin.productox.delete',
            'admin.productox.bulk-delete',
        ]);
