...
class FillPermissionsForPuntosVentum extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPuntosVentum constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.puntos-ventum',
            'admin.puntos-ventum.index',
            'admin.puntos-ventum.create',
            'admin.puntos-ventum.show',
            'admin.puntos-ventum.edit',
            'admin.puntos-ventum.delete',
            'admin.puntos-ventum.bulk-delete',
        ]);
