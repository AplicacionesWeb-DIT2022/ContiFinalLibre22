...
class FillPermissionsForMercaderium extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForMercaderium constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.mercaderium',
            'admin.mercaderium.index',
            'admin.mercaderium.create',
            'admin.mercaderium.show',
            'admin.mercaderium.edit',
            'admin.mercaderium.delete',
            'admin.mercaderium.bulk-delete',
        ]);
