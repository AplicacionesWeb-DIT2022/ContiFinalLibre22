<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
           ...
           <li class="nav-item"><a class="nav-link" href="{{ url('admin/productoxes') }}"><i class="nav-icon icon-flag"></i> {{ trans('admin.productox.title') }}</a></li>
           <li class="nav-item"><a class="nav-link" href="{{ url('admin/mercaderia') }}"><i class="nav-icon icon-graduation"></i> {{ trans('admin.mercaderium.title') }}</a></li>
