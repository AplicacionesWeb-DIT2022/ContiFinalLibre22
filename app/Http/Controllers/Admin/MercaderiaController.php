...
class MercaderiaController extends Controller
{
    ...
    public function index(IndexMercaderium $request)
    {
        ...
        $data = AdminListing::create(Mercaderium::class)->processRequestAndGet(
            // pass the request with params
            $request,

            // set columns to query
            ['id', 'descripcion', 'detalle', 'urlimagen', 'tipo', 'precio', 'cantidad'],

            // set columns to searchIn
            ['id', 'descripcion', 'detalle', 'urlimagen', 'tipo']
        );
        ...
        return view('admin.mercaderium.index', ['data' => $data]);
    }
